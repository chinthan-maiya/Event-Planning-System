...
function validate()
{
	...
	var b=new Array(8);
	b[0]=1000;b[1]=y*30;b[2]=y*200;b[3]=y*200;b[4]=3000;b[5]=5000;
	var x=0;
	for(var i=0;i<6;i++)
	{
		x=x+a[i]*b[i];
...
<p><input type="checkbox" id="three"name="r3" value="1">Bags</p>
...
if(isset($_POST['submit']))
{
	...
	$r5=$_POST['r5'];
	$r6=$_POST['r6'];
	$s="insert into conference(userID,venue,date,time,attendees,decorations,chairs_tables,bags,gift_items,photographer,mic) values('$user','$loc','$date','$usr_time','$att','$r1','$r2','$r3','$r4','$r5','$r6')";	
	$results1=mysql_query($s);
	if($results1)
	{
		echo "<script>alert('Requirements have been recorded')</script>";
	}
	$t="insert into order_details(userID,conference) values('$user',1)";
