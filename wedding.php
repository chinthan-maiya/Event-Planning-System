...
body
{
	...
	background: url(wed.jpg) no-repeat center center fixed; 
...
function validate()
{
	...
	var b=new Array(8);
	b[0]=3000;b[1]=y*30;b[2]=5000;b[3]=y*200;b[4]=10000;b[5]=25000;
	var x=0;
	for(var i=0;i<6;i++)
	{
		x=x+a[i]*b[i];
...
if(isset($_POST['submit']))
{
	...
	$r5=$_POST['r5'];
	$r6=$_POST['r6'];
	$s="insert into wed(userID,venue,date,time,attendees,flowers_decorations,chairs_tables,band_set,gift_items,photographer,purohit) values('$user','$loc','$date','$usr_time','$att','$r1','$r2','$r3','$r4','$r5','$r6')";	
	$results1=mysql_query($s);
	if($results1)
	{
		echo "<script>alert('Requirements have been recorded')</script>";
	}
	$t="insert into order_details(userID,wedding) values('$user',1)";
	$results2=mysql_query($t);
}
