...
<html>
  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
	...
	<body>
		...
		<div style="width: 400px; border: 1px solid #e4e4e4; padding: 20px; margin: 10px auto;">
			...
			<p><b>Not a member?</b> <a href="register.php">Register here</a></p>
		</div>
		<br><br><br><br><br><br><br><br><button type="button" class="btn btn-primary" onclick=location.href='howto.html'>User Manual</button>
		<a href="admin.php" align="right">Admin?</a>
	</body>
</html>
<?php
